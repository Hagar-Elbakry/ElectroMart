            ...
            <div class="grid gap-y-4">
              ...
              <div>
                <div class="flex justify-between items-center">
                  ...
                  <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/forget-password">Forgot password?</a>
                </div>
                <div class="relative">
