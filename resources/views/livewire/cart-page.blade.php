      ...
      <div class="md:w-3/4">
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          <table class="w-full">
              ...
              <tr wire:key="{{$item['product_id']}}">
                <td class="py-4">
                  <div class="flex items-center">
                    <img class="h-16 w-16 mr-4" src="/storage/{{$item['image']}}" alt="{{$item['name']}}">
            ...
            @empty
              <tr>
                <td colspan="5" class="text-center py-4 text-4xl font-semibold text-slate-500">No items avaliable in cart!</td>
              </tr>
            @endforelse
              <!-- More product rows -->
            </tbody>
