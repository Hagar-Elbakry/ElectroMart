			...
			<div class="md:col-span-12 lg:col-span-8 col-span-12">
				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						...
						<li>
							<input class="hidden peer" id="hosting-big" wire:model='payment_method' type="radio" value="credit card">
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="flex justify-between mb-2 font-bold">
						...
						<span>
							{{Number::currency($grand_total, 'EGP')}}
						</span>
					</div>
					<div class="flex justify-between mb-2 font-bold">
						<span>
							...
							<li class="py-3 sm:py-4">
								<div class="flex items-center">
									<div class="flex-shrink-0">
										<img alt="{{$cart_item['name']}}" class="w-12 h-12 rounded-full" src="/storage/{{$cart_item['image']}}">
										</img>
									</div>
									...
									<div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
										{{Number::currency($cart_item['total_amount'], 'EGP')}}
									</div>
								</div>
							</li>
						@endforeach
